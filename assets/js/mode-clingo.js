        ...
        "#keyword": [
          {
            ...
            regex:
              "#include\\b|#defined\\b|#show\\b|#program\\b|#const\\b|#sort\\b|#sum\\+|#sum\\b|#count\\b|#minimize\\b|#maximize\\b|#true\\b|#false\\b|#theory\\b|#min\\b|#max\\b|#inf\\b|#sup\\b|#supremum\\b|#infimum\\b|#project\\b|#external\\b|#parts\\b|#edge\\b|#heuristic\\b",
          },
        ],
        "#operator": [
          {
        ...
        "#number": [
          {
            ...
            regex:
              "\\b([1-9][0-9]{0,2}('[0-9]{3})+|[1-9][0-9]*|0b[01]+|0x[0-9a-fA-F]+|0o[0-7]+|0)\\b",
          },
        ],
        "#variable": [
          {
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var ClingoHighlightRules =
      require("./clingo_highlight_rules").ClingoHighlightRules;
