...
{% assign flagship_items_alpha = systems | where: "state", "flagship" | where_exp: "item", "item.order == nil" | sort: "title" %}
{% assign flagship_items_ordered = systems | where: "state", "flagship" | where_exp: "item", "item.order != nil" | sort: "order" %}
{% assign flagship_items = flagship_items_ordered | concat: flagship_items_alpha %}
...
{% assign ordered_systems = flagship_items | concat: major_items | concat: experimental_items | concat: deprecated_items %}
...
<script type="text/javascript" charset="utf-8">
	var posts = [
		{% for item in systems %}
			...
			{% if system_state == 'core' or system_state == 'flagship' %}
				{% assign system_state = 'flagship' %}
				{% assign state_label = 'Flagship' %}
